...
ecs::Entity * GoManager::CreatePlayer(int numplayer)
{
    ...
    //Joueur 2
        ...
        actions = {{
            { [&player]() { ecs::ComponentManager::JoueurMouvement(keysP2, player); },      [&player]() {ecs::ComponentManager::InventaireOpen(player);},   [&player]() {ecs::ComponentManager::Tir(keysP2,player); }, [&player]() {ecs::ComponentManager::JoueurStopMouvement(player); }},  // IDLE
            { [&player]() { ecs::ComponentManager::JoueurMouvement(keysP2, player); },      [&player]() {ecs::ComponentManager::InventaireOpen(player);},   [&player]() {ecs::ComponentManager::Tir(keysP2,player); }, [&player]() {ecs::ComponentManager::JoueurStopMouvement(player); }},  // RUNNING, /* additional arguments */
            { []() {},                                                                      [&player]() {ecs::ComponentManager::InventaireClose(player); }, []() {},    []() {}}  // INVENTAIRE
